      ...
      {selectedContract ? (
        <>
          <Modal.Body>
            ...
            {submitStatus === "failure" && (
              <Alert variant="danger">
                Failed to proof contract. Please try again.
              </Alert>
            )}
            <h6>
              Review the video in the player. Does it satisfy the contract?
            </h6>
          </Modal.Body>
          <Modal.Body>
            <Form>
          ...
          <Modal.Footer>
            ...
            <h6>
              Reject to refund bids, do NOT pay the contractor, and cancel the
              contract.
            </h6>
