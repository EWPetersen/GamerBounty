...
const ViewContractForm = ({ show, handleClose, selectedContract }) => {
  ...
  return (
    <Modal show={show} onHide={handleClose} centered>
      ...
      <Modal.Footer>
        <h6>
          Clicking the Delete button will remove the below contract from your
          profile and refund all bids. Are you sure?
        </h6>
        <Button
          variant="danger"
          onClick={() => handleDeleteClick(selectedContract, handleClose)}
        >
          Delete
        </Button>
