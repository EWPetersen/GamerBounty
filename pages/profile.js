...
function Profile() {
  ...
  const handleCreatedSort = (field) => {
    setCreatedSort({
      field,
      order:
        createdSort.field === field && createdSort.order === "asc"
          ? "desc"
          : "asc",
    });
  };
  ...
  const handleAcceptedSort = (field) => {
    setAcceptedSort({
      field,
      order:
        acceptedSort.field === field && acceptedSort.order === "asc"
          ? "desc"
          : "asc",
    });
  };
  ...
  const filteredRequestedContracts = requestedContracts.filter(
    (contract) =>
      contract &&
  ...
  const filteredAcceptedContracts = acceptedContracts.filter(
    (contract) =>
      contract &&
      contract.gameTitle.S.toLowerCase().includes(searchTerm.toLowerCase())
  );
          ...
          <thead>
            <tr>
              <th
                ...
                onClick={() => handleCreatedSort("gameTitle")}
              >
                Game{" "}
              ...
              <th
                className="cursor-pointer"
                onClick={() => handleCreatedSort("targetPlayer")}
              >
                Mark{" "}
              ...
              <th
                className="cursor-pointer"
                onClick={() => handleAcceptedSort("bidAmount")}
              >
                Contract Value{" "}
                  ...
                  {contract.contractStatus.S === "open" ? (
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        console.log(
                          "clicked this contract to review:",
                          contract
                        );
                      }}
                    >
            ...
            <Pagination.Prev
              onClick={() =>
                ...
                setRequestedPagination({
                  ...requestedPagination,
                  current: requestedPagination.current - 1,
                })
              }
            />
            {[
              ...Array(
                Math.ceil(
                  requestedContracts.length / requestedPagination.pageSize
                )
              ),
            ].map((x, i) => (
              <Pagination.Item
        ...
        >
          <thead>
            <tr>
              <th
                className="cursor-pointer"
                onClick={() => handleAcceptedSort("gameTitle")}
              >
                Game{" "}
                {sort.field === "gameTitle" &&
                  (sort.order === "asc" ? "↑" : "↓")}
              ...
              <th
                className="cursor-pointer"
                onClick={() => handleAcceptedSort("targetPlayer")}
              >
                Mark{" "}
                {sort.field === "targetPlayer" &&
                  (sort.order === "asc" ? "↑" : "↓")}
                  ...
                  {contract.contractStatus.S === "accepted" ? (
                    <Button
                      ...
                      onClick={() => {
                        ...
                        console.log(
                          "clicked this contract to submit proof",
                          contract
                        );
                      }}
                    >
            ...
            <Pagination.Prev
              onClick={() =>
                ...
                setAcceptedPagination({
                  ...acceptedPagination,
                  current: acceptedPagination.current - 1,
                })
              }
            />
            {[
              ...Array(
                Math.ceil(
                  acceptedContracts.length / acceptedPagination.pageSize
                )
              ),
            ].map((x, i) => (
              <Pagination.Item
